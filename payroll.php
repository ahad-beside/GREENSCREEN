<?php
	...
	if(isset($_POST['submitButton']))
	{
		...
		$result = mysql_query($q, $conn);	//serach result 21 out of 32
		$excel = new PHPExcel();
		$worksheet = 0;
		$totals = array();
		
		while($rep = mysql_fetch_assoc($result))  //excel sheet 21 create
		{
			$excel->setActiveSheetIndex($worksheet++);  //setActiveSheetIndex(0)
		...
		$writer->save('payroll.xlsx');		//coder71
